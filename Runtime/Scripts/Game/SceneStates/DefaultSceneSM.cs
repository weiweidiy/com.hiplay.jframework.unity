...
namespace JFramework.Unity
{
    ...
    /// </summary>
    public class DefaultSceneSMContext
    {
        public DefaultSceneSM sm;
    }

    public abstract class DefaultBaseSceneState : BaseSceneState<DefaultSceneSMContext, DefaultSceneType>
    {
        public DefaultBaseSceneState(IAssetsLoader assetsLoader, IJUIManager uiManager, EventManager eventManager) : base(assetsLoader, uiManager, eventManager)
        {
        }
    }


    public class DefaultSceneSM : BaseSMAsync<DefaultSceneSMContext, DefaultBaseSceneState, DefaultSceneSMTrigger>
    {
        ...
        public DefaultSceneSM(IAssetsLoader assetsLoader, IJUIManager uiManager, EventManager eventManager, DefaultSceneSMContext context) : base(assetsLoader, uiManager, eventManager, context)
        {
            context.sm = this;
        }
