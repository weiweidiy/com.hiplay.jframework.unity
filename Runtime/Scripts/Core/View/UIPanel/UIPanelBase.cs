...
{
    /// <summary>
    /// 不带属性的UI面板基类，并且会发送面板显示事件
    /// </summary>
    public abstract class UIPanelBase : APanelController
    {
        public event Action<UIPanelBase> onPanelEnable;
        public event Action<UIPanelBase> onPanelShow;
        public event Action<UIPanelBase> onPanelHide;
        public event Action<UIPanelBase> onPanelRefresh;
        ...
        protected virtual void OnPanelRefresh() { onPanelRefresh?.Invoke(this); }
