...
namespace deVoid.UIFramework
{
    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        public IPanelController ShowPanel(string screenId) {
            return panelLayer.ShowScreenById(screenId);
        }
        ...
        public IPanelController ShowPanel<T>(string screenId, T properties) where T : IPanelProperties {
           return panelLayer.ShowScreenById<T>(screenId, properties);
        }
