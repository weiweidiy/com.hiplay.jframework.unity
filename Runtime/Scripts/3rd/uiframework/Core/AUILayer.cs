...
namespace deVoid.UIFramework {
    ...
    public abstract class AUILayer<TScreen> : MonoBehaviour where TScreen : IUIScreenController {
        ...
        /// </summary>
        /// <param name="screenId">TargetImg ScreenId</param>
        ...
        public TScreen ShowScreenById(string screenId) {
            TScreen ctl;
        ...
        public TScreen ShowScreenById<TProps>(string screenId, TProps properties) where TProps : IScreenProperties {
            TScreen ctl;
            if (registeredScreens.TryGetValue(screenId, out ctl)) {
